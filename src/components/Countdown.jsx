...
const Countdown = ( {containerClasses, targetDate} ) => {
  ...
  if (!timeLeft) {
    return (
      <div className="text-center text-3xl font-bold font-['Tangerine'] text-white">
        ¡Llegó el día!
      </div>
    );
  }
  ...
  return (
    <div className={containerClasses} data-aos="fade-in">
      <h3 className="text-xl leading-loose font-['Quicksand']">Faltan...</h3>
      <div className="flex flex-col sm:flex-row items-center justify-center space-y-8 sm:space-y-0 sm:space-x-8 text-xl font-['Quicksand']" data-aos="fade-in">
