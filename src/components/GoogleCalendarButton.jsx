...
const GoogleCalendarButton = ({
  ...
  return (
    ...
    >
      ...
      <h3 className={`text-lg font-['Quicksand'] ${titleClass}`}>
      ...
      <a
        ...
        className={`border-2 rounded-full py-3 px-6 transition hover:transform hover:scale-105 font-semibold font-['Quicksand'] ${buttonClass}`}
      >
