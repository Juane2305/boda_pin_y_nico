...
const Asistencia = ({clase, claseButton, claseTitle, linkAsistencia}) => {
  ...
  return (
    <div className={`pb-20 pt-20 ${clase} `}>
        <div className='h-full flex flex-col justify-center items-center space-y-2'>
            <h2 className={`text-3xl md:text-4xl font-light text-center font-['Quicksand'] ${claseTitle}`} data-aos= 'fade-up'>Confirmación de Asistencia</h2>   
